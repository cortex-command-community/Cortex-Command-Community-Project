function Create(self)
	...
	self.fireRatePenaltyPerShot = 100;
	self.fireRateRevertIncrement = 6;
...
function ThreadedUpdate(self)
	...
	if self.FiredFrame then
		...
		self.InheritedRotAngleOffset = self.InheritedRotAngleOffset + RangeRand(1.1, 1.2)/math.sqrt(1 + parent.Mass + parent.Material.StructuralIntegrity * 0.1);
