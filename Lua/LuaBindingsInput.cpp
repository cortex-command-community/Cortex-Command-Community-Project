...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	LuaBindingRegisterFunctionDefinitionForType(InputLuaBindings, InputDevice) {
		auto luaType = EnumTypeLuaClassDefinition(InputDevice, "InputDevice", {
			...
			{ "DEVICE_GAMEPAD_2", InputDevice::DEVICE_GAMEPAD_2 },
			{ "DEVICE_GAMEPAD_3", InputDevice::DEVICE_GAMEPAD_3 },
			{ "DEVICE_GAMEPAD_4", InputDevice::DEVICE_GAMEPAD_4 },
			{ "DEVICE_COUNT", InputDevice::DEVICE_COUNT }
		});
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	LuaBindingRegisterFunctionDefinitionForType(InputLuaBindings, InputElements) {
		auto luaType = EnumTypeLuaClassDefinition(InputElements, "InputElements", {
			...
			{ "INPUT_L_RIGHT", InputElements::INPUT_L_RIGHT },
			{ "INPUT_R_UP", InputElements::INPUT_R_UP },
			{ "INPUT_R_DOWN", InputElements::INPUT_R_DOWN },
			{ "INPUT_R_LEFT", InputElements::INPUT_R_LEFT },
			{ "INPUT_R_RIGHT", InputElements::INPUT_R_RIGHT },
			{ "INPUT_FIRE", InputElements::INPUT_FIRE },
			{ "INPUT_AIM", InputElements::INPUT_AIM },
			{ "INPUT_AIM_UP", InputElements::INPUT_AIM_UP },
			{ "INPUT_AIM_DOWN", InputElements::INPUT_AIM_DOWN },
			{ "INPUT_AIM_LEFT", InputElements::INPUT_AIM_LEFT },
			{ "INPUT_AIM_RIGHT", InputElements::INPUT_AIM_RIGHT },
			{ "INPUT_PIEMENU_ANALOG", InputElements::INPUT_PIEMENU_ANALOG },
			{ "INPUT_PIEMENU_DIGITAL", InputElements::INPUT_PIEMENU_DIGITAL },
			{ "INPUT_JUMP", InputElements::INPUT_JUMP },
			{ "INPUT_CROUCH", InputElements::INPUT_CROUCH },
			{ "INPUT_NEXT", InputElements::INPUT_NEXT },
			{ "INPUT_PREV", InputElements::INPUT_PREV },
			{ "INPUT_START", InputElements::INPUT_START },
			{ "INPUT_BACK", InputElements::INPUT_BACK },
			{ "INPUT_COUNT", InputElements::INPUT_COUNT }
		});
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	LuaBindingRegisterFunctionDefinitionForType(InputLuaBindings, MouseButtons) {
		auto luaType = EnumTypeLuaClassDefinition(MouseButtons, "MouseButtons", {
			...
			{ "MOUSE_MIDDLE", MouseButtons::MOUSE_MIDDLE },
			{ "MAX_MOUSE_BUTTONS", MouseButtons::MAX_MOUSE_BUTTONS }
		});
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	LuaBindingRegisterFunctionDefinitionForType(InputLuaBindings, JoyButtons) {
		auto luaType = EnumTypeLuaClassDefinition(JoyButtons, "JoyButtons", {
			...
			{ "JOY_3", JoyButtons::JOY_3 },
			{ "JOY_4", JoyButtons::JOY_4 },
			{ "JOY_5", JoyButtons::JOY_5 },
			{ "JOY_6", JoyButtons::JOY_6 },
			{ "JOY_7", JoyButtons::JOY_7 },
			{ "JOY_8", JoyButtons::JOY_8 },
			{ "JOY_9", JoyButtons::JOY_9 },
			{ "JOY_10", JoyButtons::JOY_10 },
			{ "JOY_11", JoyButtons::JOY_11 },
			{ "JOY_12", JoyButtons::JOY_12 },
			{ "MAX_JOY_BUTTONS", JoyButtons::MAX_JOY_BUTTONS }
		});
	}
