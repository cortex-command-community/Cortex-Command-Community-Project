...
void RTEError::TriggerGameInitModuleLoadingThreadAbort(const std::string& description, std::source_location sourceLoc) {
	g_PresetMan.GameInitModuleLoadingThreadAbort(description, sourceLoc);
}
