...
#pragma region AI Constants
	static constexpr float c_PathFindingDefaultDigStrength = 40.0F; //!< A default pathfinder penetration value that'll allow pathing through corpses, debris, and such stuff.
#pragma endregion
