...
LuaBindingRegisterFunctionDefinitionForType(ActivityLuaBindings, Activity) {
	return AbstractTypeLuaClassDefinition(Activity, Entity)
	    ...
	    .enum_("Players")[luabind::value("PLAYER_NONE", Players::NoPlayer),
	    ...
	    .enum_("ActivityState")[luabind::value("NOACTIVITY", Activity::ActivityState::NoActivity),
	    ...
	    .enum_("Team")[luabind::value("NOTEAM", Activity::Teams::NoTeam),
	    ...
	    .enum_("ViewState")[luabind::value("NORMAL", Activity::ViewState::Normal),
	    ...
	    .enum_("DifficultySetting")[luabind::value("MINDIFFICULTY", Activity::DifficultySetting::MinDifficulty),
	    ...
	    .enum_("AISkillSetting")[luabind::value("MINSKILL", Activity::AISkillSetting::MinSkill),
...
LuaBindingRegisterFunctionDefinitionForType(ActivityLuaBindings, GameActivity) {
	return luabind::class_<GameActivity, Activity>("GameActivity")
	    ...
	    .def("SetOverridePurchaseList", (int(GameActivity::*)(const std::string&, int)) & GameActivity::SetOverridePurchaseList)
	    ...
	    .enum_("ObjectiveArrowDir")[luabind::value("ARROWDOWN", GameActivity::ObjectiveArrowDir::ARROWDOWN),
