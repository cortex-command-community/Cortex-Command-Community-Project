...
LuaBindingRegisterFunctionDefinitionForType(EntityLuaBindings, MovableObject) {
	return AbstractTypeLuaClassDefinition(MovableObject, SceneObject)
	    ...
	    .def("HasStringValue", &MovableObject::StringValueExists)
	    .def("HasNumberValue", &MovableObject::NumberValueExists)
	    .def("HasObjectValue", &MovableObject::ObjectValueExists)
