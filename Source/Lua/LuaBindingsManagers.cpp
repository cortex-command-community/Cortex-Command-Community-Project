...
LuaBindingRegisterFunctionDefinitionForType(ManagerLuaBindings, SceneMan) {
	return luabind::class_<SceneMan>("SceneManager")
	    ...
	    .def("CastSeeRay", (bool(SceneMan::*)(int, const Vector&, const Vector&, Vector&, int, int)) & SceneMan::CastSeeRay)
	    .def("CastUnseeRay", (bool(SceneMan::*)(int, const Vector&, const Vector&, Vector&, int, int)) & SceneMan::CastUnseeRay)
