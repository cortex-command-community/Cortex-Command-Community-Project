...
#pragma region Script Execution Handling
		...
		/// If either argument list has entries, they will be passed into the function in order, with entity arguments first.
		/// @param functionObjectWrapper The SolObjectWrapper containing the Lua function to be run.
		...
		/// @param outFunctionNamesAndObjects The map of function names to SolObjectWrappers to be retrieved from the script that was run.
