...
#pragma region Getters and Setters
		...
		/// @return The true update dt, in ms.
		...
		/// @return A predicted proportion of how complete the current update cycle is.
