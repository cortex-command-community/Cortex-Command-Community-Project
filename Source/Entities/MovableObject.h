...
#pragma endregion
		...
		/// @param newPos New position for this MovableObject.
		/// @param teleport Whether we're teleporting or moving smoothly. If we teleport, we don't interpolate between positions when rendering.
