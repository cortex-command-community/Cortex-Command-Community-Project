...
#pragma region Getters and Setters
		...
		void SetGameOverRound(int gameOverRound);
		...
		bool IsGameOverByRound(int whichRound) const;
		...
		std::string GetOffensiveTargetName() const;
		...
		void SetOffensiveTargetName(std::string targetName);
#pragma endregion
...
#pragma region Funds and Costs
		...
		float ChangeFunds(float howMuch);
		...
		float GetForeignCostMultiplier() const;
		...
		float GetNativeCostMultiplier() const;
		...
		void SetNativeCostMultiplier(float newNativeCostMult);
#pragma endregion
...
#pragma region Brain Pool
		...
		void SetBrainPoolCount(int brainCount);
		...
		int ChangeBrainPoolCount(int change);
		...
		void SetBrainsInTransit(int transitCount);
		...
		/// @return The resulting count after the alteration.
		int ChangeBrainsInTransit(int change);
#pragma endregion
